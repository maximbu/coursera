...
//        }
    	...
    	String arg = "D:\\Studies\\Algo2\\Ex2\\seamCarving-testing\\seamCarving\\4x6.png";

        Picture inputImg = new Picture(arg);
        int removeColumns = 1;//Integer.parseInt(args[1]);
        int removeRows = 1;//Integer.parseInt(args[2]); 
